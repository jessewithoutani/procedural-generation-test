 ...
 * Currently just modified to support capsules
*/
...
function getCollider(geometry) {
	...
	if (geometry.type === 'BoxGeometry') {
        ...
        // https://gameworksdocs.nvidia.com/PhysX/3.4/PhysXGuide/_images/GeomTypeCapsule.png

        const halfHeight = parameters.length;
...
async function RapierPhysics() {
	...
	function addMesh(mesh, mass = 0, restitution = 0) {
        ...
        console.log(`heheheheh ${JSON.stringify(shape)}`);
	...
	function setMeshVelocity(mesh, velocity, index = 0) {
        ...
        // console.log(`pp ${JSON.stringify(body)} ${JSON.stringify(meshMap)}`);
